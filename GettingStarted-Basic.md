...
```zsh
export GH_USERNAME="rakshita-vijay"; export DOTFILES_BRANCH="master"; curl -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh
```
