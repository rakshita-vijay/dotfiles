...
=======
export GH_USERNAME="rakshita-vijay" DOTFILES_BRANCH="master" HOMEBREW_BASE_INSTALL="true"; curl -fsSL "https://raw.githubusercontent.com/${GH_USERNAME}/dotfiles/refs/heads/${DOTFILES_BRANCH}/scripts/fresh-install-of-osx.sh" | zsh; unset HOMEBREW_BASE_INSTALL
>>>>>>> 3d68f36 (Normalized for dotfiles repo on Mon Jul 7 04:09:18 IST 2025)
```
