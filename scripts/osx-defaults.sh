...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/rakshita-vijay/dotfiles/master/scripts/osx-defaults.sh)"
#
# or run it without prompt questions:
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/rakshita-vijay/dotfiles/master/scripts/osx-defaults.sh)" -s
#
