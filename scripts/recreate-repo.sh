...
usage() {
  ...
  echo "    eg: -f ${HOME}                             (will push to keybase://private/rakshita_vijay/home)"
  echo "    eg: ${HOME}/personal/${USERNAME}/profiles  (will push to keybase://private/rakshita_vijay/profiles)"
  exit 1
}
...
git_url=$(extract_git_config_value remote.origin.url)   # "keybase://private/rakshita_vijay/home"
git_user_name=$(extract_git_config_value user.name)     # "Rakshita Vijay"
git_user_email=$(extract_git_config_value user.email)   # "rakshita-vijay@users.noreply.github.com"
