...
# curl -fsSL https://raw.githubusercontent.com/rakshita-vijay/dotfiles/master/scripts/fresh-install-of-osx-custom.sh | zsh

# Note: Change these as per your settings
USERNAME="${USERNAME:-$(whoami)}"
KEYBASE_USERNAME="${KEYBASE_USERNAME:-"rakshita_vijay"}"
